          ...
          <h1 className="my-auto font-bold text-[16px] lg:text-2xl uppercase border-r-2 lg:pr-5 lg:mr-5">
            ...
            >
              ...
              />
                    ...
                    {checkLogin() && <div
                        className="lg:hidden mr-5 p-1 border-2 border-transparent hover:text-[#3c65e0] cursor-pointer rounded">
                        <div className="dropdown z-[11]">
                            <span className={scrolled ? "text-[#000]" : "text-[#fff]"}>{getUserInfo()?.username}</span>
                            <span className={scrolled ? "text-[#31bf55]" : "text-[#fff]"}>{wallet} VND</span>
                                    ...
                                    <div className="dropdown select-none" style={{
                                        ...
                                        <div className="dropdown-content">
                                            <ul>
                                                <li>
                                                    <a
                                                        className="hover:text-[#3c65e0]" onClick={handleLogout}>Đăng
                                                        xuất</a>
                                                </li>
                                                <li><a className="hover:text-[#3c65e0]">Đổi mật khẩu</a></li>
                                                <li><a href="/recharge" className="hover:text-[#3c65e0]">Nạp thêm
                                                    tiền</a></li>
                                                <li><a href="/transaction" className="hover:text-[#3c65e0]">Lịch sử giao
                                                    dịch</a></li>
                                            </ul>
                                        </div>
                                    </div>
